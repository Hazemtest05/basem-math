...
export const problems: Problem[] = [
  {
    ...
    steps: [
      { latex: 'r=\\sqrt{(-\\sqrt3)^2+1^2}=\\sqrt{3+1}=\\hl{2}', note: 'الطويلة r دائماً موجبة.' },
      { latex: '\\cos\\theta=\\dfrac{-\\sqrt3}{2}<0,\\quad \\sin\\theta=\\dfrac{1}{2}>0', note: 'الإشارتان معاً تحدّدان الرُّبع الثاني.' },
      { latex: '\\theta=\\hl{\\dfrac{5\\pi}{6}}', note: 'لا نأخذها من الظلّ وحده.' },
    ],
    answerLatex: 'z=\\boxed{2\\left(\\cos\\dfrac{5\\pi}{6}+i\\sin\\dfrac{5\\pi}{6}\\right)}',
  ...
  },
  {
    ...
    steps: [
      { latex: 'f(x)=12x-4x^2=0\\ \\Rightarrow\\ x=\\hl{0}\\ \\text{أو}\\ x=\\hl{3}', note: 'حدود التكامل هي جذور التابع.' },
      ...
      { latex: '=(54-36)-0=\\hl{18}', note: '' },
    ],
    answerLatex: '\\boxed{\\mathcal{A}=18}\\ \\text{وحدة مساحة}',
